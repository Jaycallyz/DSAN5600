...
**Data Source**: [AHS weighted average](https://wits.worldbank.org/CountryProfile/en/Country/WLD/StartYear/1988/EndYear/2022/TradeFlow/Import/Indicator/AHS-WGHTD-AVRG/Partner/WLD/Product/Total#)  

![AHS weighted average](pic/ahs.png)  

**Description**:  
The AHS Weighted Average (%) indicator measures the average tariff rate applied to imported goods, weighted by their trade value. It provides a comprehensive picture of the effective protection level in global trade by combining both tariff rates and the composition of traded products. Unlike simple averages, this measure reflects the actual impact of tariffs on international trade flows and the degree of market openness over time.

# 4. Financial Market & Demand Indicators
## 4.1 S&P 500 Index (SP500)
**Data Source**: [FRED – S&P 500](https://fred.stlouisfed.org/series/SP500)

![S&P 500 Index](pic/sp500.png)  
<small>*Daily S&P 500 Index (aggregated to monthly for analysis). Source: FRED*</small>
...
**Data Source**: [Yahoo Finance – ^DJT](https://finance.yahoo.com/quote/%5EDJT)  

![Dow Jones Transportation / IYT](pic/djt_iyt.png)  
<small>*Transportation stocks index (or IYT ETF) as a logistics/transport proxy. Source: Yahoo Finance*</small>
...
**Data Source**: [FRED – Retail and Food Services Sales (RSAFS)](https://fred.stlouisfed.org/series/RSAFS)

![U.S. Retail Sales](pic/retail_sales.png)  
<small>*Monthly U.S. Retail & Food Services Sales (seasonally adjusted). Source: FRED*</small>
