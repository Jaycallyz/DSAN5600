...
# Final Summary
Returning to my original question: what actually drives container throughput at the Port of Los Angeles?
The answer is simpler than I expected.

Container throughput is driven by three core factors: energy costs, currency dynamics, and supply-chain stress. These forces move together in stable, linear ways that simple models capture well. Even major disruptions like COVID-19 didn't break these relationships—they just shifted the long-term trajectory.

What does this mean in practice? For port managers, forecasters, or policymakers, the lesson is clear: focus on understanding the economic drivers, not building overly complex models. The port's story is already written in oil prices, dollar strength, and supply-chain conditions—we just need to read it correctly.