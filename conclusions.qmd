...
- The Port of LA may be driven by three stable forces: oil prices, currency strength, and supply-chain conditions.
- Among all models, the simple VAR(1) model is the best one
- GARCH modeling revealed strong volatility persistence in the transportation sector
- COVID-19 created a structural shift rather than a short-term drop.
- And most importantly is to choose a model fitting your data rather than the complex one.